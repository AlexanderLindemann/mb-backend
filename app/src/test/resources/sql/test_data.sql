...
VALUES ('48d91494-d868-11ed-afa1-0242ac120002'::UUID, 'Alexander Testovich', 'test-email@gmail.com',
        '0c371042-d848-11ed-afa1-0242ac120002'::UUID);
...
VALUES ('090ec5f2-d926-11ed-afa1-0242ac120002', 20.00, 30.00, 10, 10, 5000, 100000, true),
       ('b906eca8-d928-11ed-afa1-0242ac120002', 21.00, 31.00, 11, 11, 5500, 150000, false);

INSERT INTO public.credit_program_detail (id, credit_purpose_type, real_estate_type, include, exclude)
VALUES ('98a78d76-d925-11ed-afa1-0242ac120002', 'PURCHASE_READY_HOUSE,PURCHASE_UNDER_CONSTRUCTION', 'TOWNHOUSE,APARTMENT_COMPLEX', null, 'ROSTOV,PRIMORSKY,PSKOV'),
       ('a0e076e4-d928-11ed-afa1-0242ac120002', 'PURCHASE_READY_HOUSE,PURCHASE_UNDER_CONSTRUCTION', 'TOWNHOUSE,APARTMENT_COMPLEX', null, 'ROSTOV,PRIMORSKY,PSKOV');
...
INSERT INTO public.partner (id, smart_deal_organization_id, name, type, real_estate_type, credit_purpose_type, bank_id)
VALUES ('5fec2326-d92e-11ed-afa1-0242ac120002', 123456, 'testName', 'DEVELOPER', 'APARTMENT,APARTMENT_COMPLEX', 'PURCHASE_UNDER_CONSTRUCTION,REFINANCING', '0c371042-d848-11ed-afa1-0242ac120002');

INSERT INTO public.real_estate_address (id, residential_complex_name, region, address, partner_id)
