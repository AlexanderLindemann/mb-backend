...
public class CreditProgramControllerImpl implements CreditProgramController {
    ...
    public CreditProgramResponse createCreditProgram(BankProgramRequest request) {
        CreditProgram creditProgram = creditProgramService.createCreditParameter(request, Converter.convertCreditDetailToStringFormat(request));
    ...
    public CreditProgramResponse updateProgram(UUID creditProgramId, BankProgramRequest request) {
        CreditProgram creditProgram = creditProgramService.updateProgram(creditProgramId, request, Converter.convertCreditDetailToStringFormat(request));
        return programMapper.toProgramResponseMapper(creditProgram)
                .setCreditProgramDetail(Converter.convertCreditDetailToEnumFormat(creditProgram.getCreditProgramDetail()));
    }
